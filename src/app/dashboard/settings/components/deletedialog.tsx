...
import { DeleteAccAction } from "@/action/deleteaccount";
    ...
    <Dialog>
      ...
      <DialogContent className="sm:max-w-md bg-white">
        <DialogHeader>
          ...
          <div
            className="flex items-center rounded-md bg-red-50 p-3 text-sm font-semibold text-red-800 dark:bg-red-800/40 dark:text-red-400"
            role="alert"
          >
            <p>
        ...
        <div className="mt-4 flex flex-col gap-1">
          <p className="text-sm text-muted-foreground">
            To verify, type <span className="font-bold text-black/90">delete my account</span>{" "}
            below:
          </p>
          <input
            id="verification"
            autoFocus
            className="rounded-md border p-1 px-2 focus:border-muted-foreground focus:outline-none"
            type="text"
          />
        </div>
